...
begin
  ...
  if (assigned(Btl)) then begin
    ...
    label1.Caption:='Страница 1 из '+inttostr(listPan.Count);
    button2.Enabled:=true;
    button3.Enabled:=true;
  end else begin
    label1.Caption:='Нечего печатать';
  ...
  if assigned(listPan) then begin
    ...
    if printDialog1.Execute then begin
      ...
      for i:=from_page-1 to to_page-1 do begin
        ...
        label1.Caption:='печать страницы '+inttostr(i+1)+' из '+inttostr(listpan.Count) ;
...
////////////////////////////////////////////////////////////////////
      ...
      Printer.EndDoc;
      label1.Caption:='Страница '+inttostr(listPan.Count)+' из '+inttostr(listPan.Count);
...
begin
  ...
  button2.Enabled:=true;
  button3.Enabled:=true;
  label1.Caption:='Предварительный просмотр:';
end;
...
begin
  if assigned(listPan) then begin
    ...
    label1.Caption:='Страница '+inttostr(ap+1)+' из '+inttostr(listPan.Count);
